...
string enemy_st [18] = {"Крыса", "Гигантская крыса", "Паук", "Гигантский паук", "Крыса-лучник", "Крыса-воин", "Амбал", "Волк", "Волк-вожак", "Гоблин", "Гоблин-всадник",
    "Гоблин-шаман", "Гоблин-главарь", "Скелет", "Зомби", "Призрачная гончая", "Вампир", "Королева вампиров"};
string pl_names [26] = {"Адонис", "Элиас", "Хаос", "Харон", "Гермес", "Озирис", "Орфей", "Фобос", "Янни", "Персей", "Хэймон", "Геракл", "Актеон", "Деимос", "Тритон", "Дорос",
    "Амон", "Анубис", "Иазон", "Икарус", "Креон", "Кронос", "Аргос", "Атлас", "Ксенон", "Мидас"};
